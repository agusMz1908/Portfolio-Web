...
const RedesSociales = () => {
  return (
    <div className="flex flex-row pr-3">
        ...
        <a><i className="fa-brands fa-github text-white text-3xl ml-3 hover:text-red-500"></i></a>
        <a><i className="fa-brands fa-linkedin text-white text-3xl ml-3 hover:text-red-500"></i></a>
    </div>
  )
}
